! function() {
    ...
    function i(t, e, n, i, r) {
        r.save(), r.translate(t, e), r.scale(i, i), r.rotate(Math.PI / 4), r.fillRect(-n / 2, -n / 2, n, n), r.restore()
    }
        ...
        return d(r, function(r) {
            function a() {
                function n() {
                    ...
                    c = t(s, "t"), d = t(s, "r"), p = t(s, "s"), h = t(s, "sunSize");
                    var n = v.TEXTURE_2D,
                        i = v.createTexture();
                    return v.bindTexture(n, i), e(n, v.TEXTURE_WRAP_S, v.CLAMP_TO_EDGE), e(n, v.TEXTURE_WRAP_T, v.CLAMP_TO_EDGE), e(n, v.TEXTURE_MIN_FILTER, v.LINEAR), e(n, v.TEXTURE_MAG_FILTER, v.LINEAR), v.texImage2D(n, 0, v.RGBA, v.RGBA, v.UNSIGNED_BYTE, g), !0
                }
                ...
                function a(t, e) {
                    ...
                    return null == i || null == r ? null : (v.attachShader(n, i), v.attachShader(n, r), v.deleteShader(i), v.deleteShader(r), v.linkProgram(n), v.getProgramParameter(n, v.LINK_STATUS) ? n : null)
                }
                ...
                function u() {
                    var n = "true" == r.getAttribute("data-stop-on-scroll"),
                        a = t();
                    (n && a < b.innerHeight || !n && a > e() - b.innerHeight - 200) && l(), i || _(u)
                }
                ...
                function l() {
                    if (s) {
                        ...
                        if (0 != e || 0 != E) {
                            E = e, y = (new Date).getTime() - w, v.clearColor(0, 0, 0, 0), v.clear(v.COLOR_BUFFER_BIT | v.DEPTH_BUFFER_BIT), v.useProgram(s), v.uniform1f(c, y / 1e3), v.uniform1f(p, "true" == r.getAttribute("data-stop-on-scroll") ? e : 0), v.uniform2f(d, f.width * A, f.height * A), v.uniform1f(h, S), v.bindBuffer(v.ARRAY_BUFFER, k);
                            var n;
                            v.vertexAttribPointer(n, 2, v.FLOAT, !1, 0, 0), v.enableVertexAttribArray(n), v.drawArrays(v.TRIANGLES, 0, 6), v.disableVertexAttribArray(n), v.viewport(0, 0, f.width * A, f.height * A)
                        }
                    }
                }
                var s, c, h, d, p, k, v, j = L.vert,
                    m = L.frag,
                    w = (new Date).getTime(),
                    y = 0;
                if (!n()) return !1;
            ...
            function c() {
                function t(t, e, n) {
                    ...
                    h(t.length, function(o) {
                        var u = t.charAt(o);
                        i += "." == u ? 0 : "j" == u ? -1 : 1, 0 == i || a || (a = !0, r.moveTo((d.x + (o - 1) * l * e) * A, d.y * A)), r.lineTo((d.x + o * l * e) * A, (d.y + i * l * n) * A)
                    }), r.closePath(), r.fill()
                }

                function e(e, n, i) {
                    s(n, r), r.strokeStyle = n, r.lineWidth = 4, r.lineJoin = "round", t(c.left[e], -1, -1), t(c.right[e], 1, -1), s(i, r), r.strokeStyle = i, t(c.left[e], -1, 1), t(c.right[e], 1, 1), r.strokeStyle = "transparent"
                }
                ...
                var g = n(f.width, f.height),
                    k = o(g);
                return k.drawImage(i, 0, 0), r.save(), r.globalCompositeOperation = "source-atop", r.drawImage(g, 0, 0), k.clearRect(0, 0, f.width * A, f.height * A), k.restore(), k.drawImage(i, 0, 0), r.clearRect(0, 0, f.width * A, f.height * A), r.restore(), s(w.whiteish, r), r.beginPath(), S = 2.5 * l * A, r.arc(d.x * A, d.y * A, S, Math.PI, 2 * Math.PI), r.fill(), r.drawImage(g, 0, 0), i
            }
            var f = u(r);
            p(f, A, r);
            var d = {
    ...
    function k() {
        ...
        return function n(r) {
            ...
            if (o < b.innerHeight) {
                ...
                var u = [];
                d(g, function(t) {
                    t.s += t.speed * (t.growing ? 1 : -1), t.s > 1 && (t.growing = !1), t.s < 0 || (u.push(t), i(t.x * A, t.y * A, 1, f(t.s) * t.maxSize * A, l))
                }), c(1) < 5e-7 * (b.innerWidth * b.innerHeight) && u.push(e()), g = u;
                var p = .75 * E - o;
                d(k, function(t) {
                    l.globalAlpha = t.a;
                    var e = t.p,
    ...
    ! function() {
        ...
        b.addEventListener("resize", function() {
            function o() {
                ...
                Math.abs(o - i) > y && (i = o, e.stop(), _(function() {
                    e = k()
                }))
            }
    ...
    var F = a(".Work-video").map(function(t) {
        ...
        }), t.classList.add("Work-video--paused"), document.addEventListener("touchstart", function t() {
        ...
        ! function n() {
            ...
            if (i != e) {
                ...
                d(F, function(t) {
                    ...
                    r > n - e && r < n + e ? t.playing || t.video.play() : t.playing && t.video.pause()
                })
            }
            _(n)
        }()
    ...
    function() {
        var t = r(".Email");
        l("href", "mailto:lucasbbebber@gmail.com", t), t.innerHTML = "<strong>lucasbbebber</strong>@<strong>gmail</strong>.com"
    }();
    var H = !1;
            ...
            d(t, function(t) {
                t.addEventListener("click", function(n) {
                    ...
                    var l = u(a),
                        ...
                        c = e();
                    s + b.innerHeight > c && (s = c - b.innerHeight), b.scrollTo(0, s), i.style.transform = "translate3d(0," + s + "px,0)";
                    var f = 300 + .3 * s,
                        h = 0,
                        d = s,
                        p = 0,
                    ...
                    _(function() {
                        ...
                        ! function a() {
                            ...
                            var u = d + w(h) * g,
                                l = Math.min(0, u - k + 5);
                            r = h < 1 ? [l].concat(r.slice(0, 2)) : r.slice(0, r.length - 1), k = u, n += l, i.style.transform = "translate3d(0," + u + "px,0)", (h < 1 || r.length > 0) && _(a)
                        }()
                    })
                })
            })
